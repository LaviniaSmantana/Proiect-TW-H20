...
<link rel="stylesheet" href="font-awesome-4.7.0/css/font-awesome.min.css">
    ...
    <title>SoDrO - Noncarbonated</title>
</head>
<body>
    ...
    <nav>
        ...
        <div class="nav-links" id="navLinks">
            ...
            <ul>
                ...
                <li><a href="noncarbonated.php?logout=<?php echo $user_id; ?>">LOG OUT</a></li>
...
<div class="category">
 <div class="links">
    ...
    <h3><a href="milks.php">Milks</h3></a>
    <h3><a href="syrups.php">Syrups</h3></a>
 </div>
 <?php
$result = mysqli_query($conn,"SELECT * FROM `products` where id>10 AND id<=20");
