...
<html>
    <head>
        ...
        <title>SoDrO - Perla Harghitei Water</title>
        ...
        <nav>
            ...
            <i class="fa fa-times" onclick="hideMenu()"></i>
                <ul>
                    ...
                    <li><a href="perla-harghitei.php?logout=<?php echo $user_id; ?>">LOG OUT</a></li>
...
<div class="small-container">
    <div class="row">
             <img src="../images/perla-harghitei.jpg" width="100%">
         <div class="col-2">
             <p>Perla Harghitei 2L </p>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
             <h1> Perla Harghitei Mineral Water</h1>
             <h4>3.15 Lei</h4>
             <br>
             <br>
             <!-- <h5>Cantitate</h5>
...
<!-- <h2> ABOUT PRODUCT</h2> -->
    ...
    <div class="facts">
        <p> <h3>Ingredients: </h3> Natural mineral water, calcium, magnesium, sodium, sulfate, nitrate.</p>
