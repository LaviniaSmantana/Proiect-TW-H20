        ...
        <nav>
            ...
            <i class="fa fa-times" onclick="hideMenu()"></i>
                <ul>
                    ...
                    <li><a href="schweppes-pomegranate.php?logout=<?php echo $user_id; ?>">LOG OUT</a></li>
...
<div class="small-container">
    <div class="row">
             <img src="../images/schweppesr.png" width="100%">
         <div class="col-2">
             <p> Schweppes Pomegranate 1,5 L </p>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
             <h1>Schweppes Pomegranate</h1>
             <h4>6.15 Lei</h4>
             <br>
             <br>
             <!-- <h5>Cantitate</h5>
