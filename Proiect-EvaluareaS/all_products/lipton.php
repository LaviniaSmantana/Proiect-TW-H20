        ...
        <a><img src="../images/logo.png"> </a>
            ...
            <i class="fa fa-times" onclick="hideMenu()"></i>
                <ul>
                    ...
                    <li><a href="lipton.php?logout=<?php echo $user_id; ?>">LOG OUT</a></li>
...
<div class="small-container">
    <div class="row">
             <img src="../images/lipton.jpg" width="100%">
         <div class="col-2">
             <p>Lipton Ice Tea 1.5 L </p>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
             <h1> Lipton Berries, Cranberries, Rasberries </h1>
             <h4>8.97 Lei</h4>
             <br>
             <br>
             <!-- <h5>Cantitate</h5>
...
<table id="table">
    ...
    <div class="facts">
        <p> <h3>Ingredients: </h3> Water, Fructose, Sugar, Citric Acid, Black Tea Extract, Reconstituted Cranberry Concentrate , Reconstituted Raspberry Concentrate.</p>
        <p> <h3>Category: </h3> Non-Carbonated drinks</p>
        <p> <h3>Origin of ingredients: </h3> United Kingdom</p>
        <p> <h3>Manufacturing or processing places:  </h3> United Kingdom</p>
    </div>
