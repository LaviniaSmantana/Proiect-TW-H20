        ...
        <nav>
            ...
            <i class="fa fa-times" onclick="hideMenu()"></i>
                <ul>
                    ...
                    <li><a href="sprite.php?logout=<?php echo $user_id; ?>">LOG OUT</a></li>
...
<div class="small-container">
    <div class="row">
             <img src="../images/sprite.png" width="100%">
         <div class="col-2">
             <p> Sprite 2 L </p>
...
<!-- <h2> ABOUT PRODUCT</h2> -->
    ...
    <div class="facts">
        <p> <h3>Ingredients: </h3> sparkling water, sugar, acidifiers (citric acid, malic acid), acidity corrector (sodium gluconate), <br> natural lemon-lime flavors, sweetener (stevial glycosides)</p>
        <p> <h3>Category: </h3> Carbonated drinks</p>
        <p> <h3>Countries where sold: </h3> Belgium, France, Switzerland</p>
    </div>
