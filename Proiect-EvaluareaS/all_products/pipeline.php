        ...
        <nav>
            ...
            <i class="fa fa-times" onclick="hideMenu()"></i>
                <ul>
                    ...
                    <li><a href="pipeline.php?logout=<?php echo $user_id; ?>">LOG OUT</a></li>
...
<div class="small-container">
    <div class="row">
         ...
         <div class="col-2">
             <p>Pipeline Energy Drink 250 ml </p>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
             <h1>Pipeline Energy Drink</h1>
             <h4>5.80 Lei</h4>
             <br>
             <br>
             <!-- <h5>Cantitate</h5>
...
<!-- <h2> ABOUT PRODUCT</h2> -->
    ...
    <div class="facts">
        <p> <h3>Ingredients: </h3>Carbonated water, fruit juices from concentrate (16.2%) (apple,orange,guava,pineapple,passion fruit),<br>
         sugar, glucose syrup, taurin(0.4%), acidifier (citric acid), flavours, acidity regulator (sodium citrate),<br>
         preservatives,sweeteners,caffeine, vitamins, vegetable oils, sodium chloride</p>
