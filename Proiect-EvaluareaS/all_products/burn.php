        ...
        <nav>
            ...
            <i class="fa fa-times" onclick="hideMenu()"></i>
                <ul>
                    ...
                    <li><a href="burn.php?logout=<?php echo $user_id; ?>">LOG OUT</a></li>
...
<div class="small-container">
    <div class="row">
             <img src="../images/burn.png" width="100%">
         <div class="col-2">
             <p>Burn Energy Drink 250 ml </p>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
             <h1>Burn Energy Drink</h1>
             <h4>3.90 Lei</h4>
             <br>
             <br>
             <!-- <h5>Cantitate</h5>
...
<!-- <h2> ABOUT PRODUCT</h2> -->
    ...
    <div class="facts">
        <p> <h3>Ingredients: </h3>Carbonated water, sucrose, acidifier (citric acid), taurine 0.4%, acidity regulator (sodium citrates),<br> preservatives (potassium sorbate, sodium benzoate), coloring (E150d), aromas, caffeine 0.03%, inositol,<br> vitamins (B3, B5, B6, B12), guarana seed extract 0.005%, antioxidant (ascorbic acid).</p>
        <p> <h3>Category: </h3> Energy drinks</p>
        <p> <h3>Labels, certifications, awards: </h3>Not advised for specific people, Green Dot, Not advised for children and pregnant women</p>
