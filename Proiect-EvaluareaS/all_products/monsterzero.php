        ...
        <nav>
            ...
            <i class="fa fa-times" onclick="hideMenu()"></i>
                <ul>
                    ...
                    <li><a href="monsterzero.php?logout=<?php echo $user_id; ?>">LOG OUT</a></li>
...
<div class="small-container">
    <div class="row">
             <img src="../images/monsterzero.png" width="100%">
         <div class="col-2">
             <p>Monster Ultra Zero White Energy Drink 250 ml </p>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
             <h1>Monster Ultra Zero White Energy Drink</h1>
             <h4>5.40 Lei</h4>
             <br>
             <br>
             <!-- <h5>Cantitate</h5>
...
<!-- <h2> ABOUT PRODUCT</h2> -->
    ...
    <div class="facts">
        <p> <h3>Ingredients: </h3>Carbonated Water, Acidifier (Citric Acid), Taurine (0.4%), Acidity Regulator (Sodium Citrate), Flavourings,<br> Ginseng Root Extract (0.08%), Sweeteners (Sucralose, Acesulfame-K), preservatives (sorbic acid, benzoic acid), <br>caffeine (0.02%),l-carnitine l-tartrate (0.015%), vitamins (b3, b5, b6, b12), sodium chloride, d-glucuronolactone,<br> extract of guarana seed (0.002%), inositol.</p>
        <p> <h3>Category: </h3> Energy drinks</p>
        <p> <h3>Labels, certifications, awards: </h3>Low or no sugar, Sugar-free, Calorie-free</p>
        <p> <h3>Countries where sold:  </h3> France, Spain</p>
    </div>
