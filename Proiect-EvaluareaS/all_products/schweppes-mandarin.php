        ...
        <nav>
            ...
            <i class="fa fa-times" onclick="hideMenu()"></i>
                <ul>
                    ...
                    <li><a href="schweppes-mandarin.php?logout=<?php echo $user_id; ?>">LOG OUT</a></li>
...
<div class="small-container">
    <div class="row">
             <img src="../images/schweppesm.png" width="100%">
         <div class="col-2">
             <p> Schweppes Mandarin 1,5 L </p>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
             <h1> Schweppes Mandarin </h1>
             <h4>5.39 Lei</h4>
             <br>
             <br>
             <!-- <h5>Cantitate</h5>
...
<!-- <h2> ABOUT PRODUCT</h2> -->
    ...
    <div class="facts">
        <p> <h3>Ingredients: </h3>Water, sugar, tangerine juice (min.2%) of concentrate, carbon dioxide, citric acid acidifier,<br> flavors, antioxidant ascorbic acid, stabilizers E414 and E445, potassium sorbate preservative, carotene dye.</p>
        <p> <h3>Category: </h3> Carbonated drinks</p>
        <p> <h3>Labels, certifications, awards:</h3>Green Dot, With sweeteners</p>
        <p> <h3>Countries where sold: </h3>Romania</p>
    </div>
