        ...
        <a><img src="../images/logo.png"> </a>
            ...
            <i class="fa fa-times" onclick="hideMenu()"></i>
                <ul>
                    ...
                    <li><a href="pfanner.php?logout=<?php echo $user_id; ?>">LOG OUT</a></li>
...
<div class="small-container">
    <div class="row">
             <img src="../images/pfanner.jpg" width="100%">
         <div class="col-2">
         <p>Pfanner Bio 0.5 L </p>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
             <h1> Pfanner Bio Pomegranate</h1>
             <h4>14.89 Lei</h4>
             <br>
             <br>
             <!-- <h5>Cantitate</h5>
...
<table id="table">
    ...
    <div class="facts">
        <p> <h3>Ingredients: </h3> Pomegranate Juice , Water, Sugar, Flavours, Vitamin C.</p>
        <p> <h3>Category: </h3> Non-Carbonated drinks</p>
        <p> <h3>Origin of ingredients: </h3> Greece</p>
        <p> <h3>Manufacturing or processing places:  </h3> Germany</p>
    </div>
