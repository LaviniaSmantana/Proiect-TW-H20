...
<html>
    <head>
        ...
        <title>SoDrO - Raspberry Syrup</title>
        ...
        <nav>
            ...
            <i class="fa fa-times" onclick="hideMenu()"></i>
                <ul>
                    ...
                    <li><a href="sirop-zmeura.php?logout=<?php echo $user_id; ?>">LOG OUT</a></li>
...
<div class="small-container">
    <div class="row">
             <img src="../images/sirop-zmeura.png" width="100%">
         <div class="col-2">
             <p>Raspberry Syrup 0.7L </p>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
             <h1> Raspberry Syrup Mautner</h1>
             <h4>14.90 Lei</h4>
             <br>
             <br>
             <!-- <h5>Cantitate</h5>
...
<!-- <h2> ABOUT PRODUCT</h2> -->
    ...
    <div class="facts">
        <p> <h3>Ingredients: </h3> Water, raspberry juice concentrate (16%), apple juice from apple juice concentrate (8.5%), acidifier.</p>
