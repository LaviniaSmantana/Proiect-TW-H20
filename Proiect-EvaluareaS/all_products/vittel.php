...
<html>
    <head>
        ...
        <title>SoDrO - Vittel Water</title>
        ...
        <nav>
            ...
            <i class="fa fa-times" onclick="hideMenu()"></i>
                <ul>
                    ...
                    <li><a href="vittel.php?logout=<?php echo $user_id; ?>">LOG OUT</a></li>
...
<div class="small-container">
    <div class="row">
             <img src="../images/vittel.jpg" width="100%">
         <div class="col-2">
             <p>Vittel 2L </p>
...
<!-- <h2> ABOUT PRODUCT</h2> -->
    ...
    <div class="facts">
        <p> <h3>Ingredients: </h3> Natural water, calcium, magnesium, sodium, sulfate, nitrate.</p>
        <p> <h3>Category: </h3> Waters</p>
        <p> <h3>Origin of ingredients: </h3> France</p>
        <p> <h3>Manufacturing or processing places:  </h3> France, Belgium</p>
    </div>
