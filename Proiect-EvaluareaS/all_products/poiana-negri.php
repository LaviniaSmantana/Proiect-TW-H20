...
<html>
    <head>
        ...
        <title>SoDrO - Poiana Negri Water</title>
        ...
        <nav>
            ...
            <i class="fa fa-times" onclick="hideMenu()"></i>
                <ul>
                    ...
                    <li><a href="poiana-negri.php?logout=<?php echo $user_id; ?>">LOG OUT</a></li>
...
<div class="small-container">
    <div class="row">
             <img src="../images/poiana-negri.jpg" width="100%">
         <div class="col-2">
             <p>Poiana Negri 2L </p>
                 ...
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
             <h1> Poiana Negri Mineral Water</h1>
             <h4>2.75 Lei</h4>
             <br>
             <br>
             <!-- <h5>Cantitate</h5>
