...
<html>
    <head>
        ...
        <title>SoDrO - Bucovina Water</title>
        ...
        <nav>
            ...
            <i class="fa fa-times" onclick="hideMenu()"></i>
                <ul>
                    ...
                    <li><a href="bucovina.php?logout=<?php echo $user_id; ?>">LOG OUT</a></li>
...
<div class="small-container">
    <div class="row">
             <img src="../images/bucovina-2l.jpg" width="100%">
         <div class="col-2">
             <p>Bucovina 2L </p>
