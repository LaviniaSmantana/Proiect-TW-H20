...
<html>
    ...
    <link rel="stylesheet" href=" C:\Users\user\Desktop\font-awesome-4.7.0\font-awesome-4.7.0\css\font-awesome.min.css">
        ...
        <nav>
            ...
            <i class="fa fa-times" onclick="hideMenu()"></i>
                <ul>
                    ...
                    <li><a href="fanta-orange.php?logout=<?php echo $user_id; ?>">LOG OUT</a></li>
...
<div class="small-container">
    <div class="row">
             <img src="../images/fantap.png" width="100%">
         <div class="col-2">
             <p> Fanta Orange 2 L </p>
...
<!-- <h2> ABOUT PRODUCT</h2> -->
    ...
    <table id="table">
        <tr>
            ...
            <th>Per serving (250 ml)</th>
        </tr>
        <tr>
           <td>Energy</td>
           <td>113 kj (27 kcal)</td>
        </tr>
        <tr>
            <td>Fat</td>
            <td>0 g</td>
    ...
    <div class="facts">
        <p> <h3>Ingredients: </h3>  carbonated water, orange juice based on concentrate 10%, sugar,<br> lemon juice based on concentrate 2%, preservative: potassium sorbate, <br> natural orange flavors with other natural flavors, <br> sweeteners: acesulfame-k, sucralose, stabilizer: guar gum, color: carotenoids</p>
        <p> <h3>Category: </h3> Carbonated drinks</p>
        <p> <h3>Manufacturing or processing places: </h3>Fabriqué en France </p>
        <p> <h3>Countries where sold: </h3> Belgium, France</p>
    </div>
