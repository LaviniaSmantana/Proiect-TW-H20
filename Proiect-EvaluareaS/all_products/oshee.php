...
<html>
    <head>
        ...
        <title>SoDrO - Oshee Vitamin</title>
        ...
        <a><img src="../images/logo.png"> </a>
            ...
            <i class="fa fa-times" onclick="hideMenu()"></i>
                <ul>
                    ...
                    <li><a href="oshee.php?logout=<?php echo $user_id; ?>">LOG OUT</a></li>
...
<div class="small-container">
    <div class="row">
             <img src="../images/oshee.jpg" width="100%">
         <div class="col-2">
             <p>Oshee Vitamin 550 ml  </p>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
             <h1>Oshee Vitamin Water</h1>
             <h4>6.90 Lei</h4>
             <br>
             <br>
             <!-- <h5>Cantitate</h5>
...
<!-- <h2> ABOUT PRODUCT</h2> -->
    ...
    <div class="facts">
        <p> <h3>Ingredients: </h3> Water, Sugar, Acidity Regulator, Citric Acid, Black Carrot Concentrate, Iodine, Vitamin B12</p>
