        ...
        <nav>
            ...
            <i class="fa fa-times" onclick="hideMenu()"></i>
                <ul>
                    ...
                    <li><a href="schweppes-lemon.php?logout=<?php echo $user_id; ?>">LOG OUT</a></li>
...
<div class="small-container">
    <div class="row">
             <img src="../images/schweppesl.png" width="100%">
         <div class="col-2">
             <p> Schweppes Bitter Lemon 1,5 L </p>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
             <h1> Schweppes Bitter Lemon </h1>
             <h4>5.39 Lei</h4>
             <br>
             <br>
             <!-- <h5>Cantitate</h5>
...
<!-- <h2> ABOUT PRODUCT</h2> -->
    ...
    <div class="facts">
        <p> <h3>Ingredients: </h3>Carbonated water, sugar, natural lemon extracts, acidifier: citric acid, <br> natural lemon flavorings with other natural flavorings, preservative: potassium sorbate, sweeteners: <br> acesulfame K, sucralose, modified starch, stabilizers (E445, E444).</p>
        <p> <h3>Category: </h3> Carbonated drinks</p>
        <p> <h3>Labels, certifications, awards:</h3>Green Dot, With sweeteners</p>
        <p> <h3>Countries where sold: </h3> France</p>
    </div>
