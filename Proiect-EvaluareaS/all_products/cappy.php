...
<html>
    <head>
        ...
        <title>SoDrO - Cappy Orange Juice</title>
        ...
        <a><img src="../images/logo.png"> </a>
            ...
            <i class="fa fa-times" onclick="hideMenu()"></i>
                <ul>
                    ...
                    <li><a href="cappy.php?logout=<?php echo $user_id; ?>">LOG OUT</a></li>
...
<div class="small-container">
    <div class="row">
             <img src="../images/cappy.jpg" width="100%">
         <div class="col-2">
             <p>Cappy Pulpy 1.5 L </p>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
             <h1> Cappy Pulpy Orange Juice </h1>
             <h4>8.53 Lei</h4>
             <br>
             <br>
             <!-- <h5>Cantitate</h5>
...
<table id="table">
    ...
    <div class="facts">
        <p> <h3>Ingredients: </h3> Water, Fructose-Glucose Syrup, Orange Juice Concentrate, Pulp Orange, Citric Acid.</p>
