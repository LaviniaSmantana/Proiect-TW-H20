...
<html>
    <head>
        ...
        <title>SoDrO - Aqua Carpatica 5L Water</title>
        ...
        <nav>
            ...
            <i class="fa fa-times" onclick="hideMenu()"></i>
                <ul>
                    ...
                    <li><a href="aqua-carpatica-5l.php?logout=<?php echo $user_id; ?>">LOG OUT</a></li>
...
<div class="small-container">
    <div class="row">
             <img src="../images/aqua-carpatica-5l.jpg" width="100%">
         <div class="col-2">
             <p>Aqua Carpatica 5 L </p>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
             <h1> Aqua Carpatica Water</h1>
             <h4>7.49 Lei</h4>
             <br>
             <br>
             <!-- <h5>Cantitate</h5>
             ...
             <p> 
                <img src="../images/nutri-A.png"> 
                <img src="../images/nova-1.png">    
            </p>
         </div>
    </div>
</div>
...
<!-- <h2> ABOUT PRODUCT</h2> -->
    ...
    <div class="facts">
        <p> <h3>Ingredients: </h3> Calcium, magnesium, sodium, hydrogencarbonate, nitrate.</p>
        <p> <h3>Category: </h3> Waters</p>
        <p> <h3>Origin of ingredients: </h3> France</p>
        <p> <h3>Manufacturing or processing places:  </h3> France</p>
    </div>
