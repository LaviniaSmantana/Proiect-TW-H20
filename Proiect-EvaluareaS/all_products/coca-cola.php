        ...
        <nav>
            ...
            <i class="fa fa-times" onclick="hideMenu()"></i>
                <ul>
                    ...
                    <li><a href="coca-cola.php?logout=<?php echo $user_id; ?>">LOG OUT</a></li>
...
<div class="small-container">
    <div class="row">
             <img src="../images/coca-cola.png" width="100%">
         <div class="col-2">
             <p>Coca-Cola 2 L </p>
...
.css-button-text {
    ...
    <div class="facts">
        <p> <h3>Ingredients: </h3> Water, Sugar, Carbon Dioxide, Dye E 150d, Phosphoric Acid Acidifier, Aromaturals Including Caffeine.</p>
