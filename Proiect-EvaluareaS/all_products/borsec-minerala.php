...
<html>
    <head>
        ...
        <title>SoDrO - Borsec Water</title>
        ...
        <nav>
            ...
            <i class="fa fa-times" onclick="hideMenu()"></i>
                <ul>
                    ...
                    <li><a href="borsec-minerala.php?logout=<?php echo $user_id; ?>">LOG OUT</a></li>
...
<div class="small-container">
    <div class="row">
             <img src="../images/borsec-minerala.jpg" width="100%">
         <div class="col-2">
             <p>Borsec 0.75L </p>
