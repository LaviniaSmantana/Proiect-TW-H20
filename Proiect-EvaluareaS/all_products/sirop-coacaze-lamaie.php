...
<html>
    <head>
        ...
        <title>SoDrO - Blackcurrant-Lemon Syrup</title>
        ...
        <nav>
            ...
            <i class="fa fa-times" onclick="hideMenu()"></i>
                <ul>
                    ...
                    <li><a href="sirop-coacaze-lamaie.php?logout=<?php echo $user_id; ?>">LOG OUT</a></li>
...
<div class="small-container">
    <div class="row">
             <img src="../images/sirop-coacaze-lamaie.png" width="100%">
         <div class="col-2">
             <p>Blackcurrant-lemon Syrup 0.7L </p>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
             <h1> Blackcurrant-lemon Syrup Mautner</h1>
             <h4>14.00 Lei</h4>
             <br>
             <br>
             <!-- <h5>Cantitate</h5>
...
<!-- <h2> ABOUT PRODUCT</h2> -->
    ...
    <div class="facts">
        <p> <h3>Ingredients: </h3> Water, blackcurrant juice from concentrate (30%), lemon juice from concentrate (5%), acidifier: citric acid; sweeteners. </p>
        <p> <h3>Category: </h3> Syrups</p>
        <p> <h3>Origin of ingredients: </h3>Germany</p>
        <p> <h3>Manufacturing or processing places:  </h3> Austria, Germany</p>
    </div>
