        ...
        <nav>
            ...
            <i class="fa fa-times" onclick="hideMenu()"></i>
                <ul>
                    ...
                    <li><a href="redbull.php?logout=<?php echo $user_id; ?>">LOG OUT</a></li>
...
<div class="small-container">
    <div class="row">
             <img src="../images/RedBull.png" width="100%">
         <div class="col-2">
...
<!-- <h2> ABOUT PRODUCT</h2> -->
    ...
    <div class="facts">
        <p> <h3>Ingredients: </h3> carbonated water, sucrose, glucose, acidifier (citric acid), taurine (0.4%), <br> acidity correctors (sodium citrate, magnesium carbonate), caffeine (0.02%), <br> vitamins (niacin, pantothenic acid, b6, b12), flavors, colors (caramel, riboflavin)</p>
        <p> <h3>Category: </h3> Energy drinks</p>
        <p> <h3>Countries where sold:  </h3> Spain, Alemania, Bélgica, Francia, Suiza</p>
    </div>
