...
<html>
    <head>
        ...
        <title>SoDrO - Aqua Carpatica Water</title>
        ...
        <nav>
            ...
            <i class="fa fa-times" onclick="hideMenu()"></i>
                <ul>
                    ...
                    <li><a href="aqua-carpatica-2l.php?logout=<?php echo $user_id; ?>">LOG OUT</a></li>
...
<div class="small-container">
    <div class="row">
             <img src="../images/aqua-carpatica.jpg" width="100%">
         <div class="col-2">
             <p>Aqua Carpatica 2L </p>
