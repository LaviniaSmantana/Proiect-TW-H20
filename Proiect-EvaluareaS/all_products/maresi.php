        ...
        <a><img src="../images/logo.png"> </a>
            ...
            <i class="fa fa-times" onclick="hideMenu()"></i>
                <ul>
                    ...
                    <li><a href="maresi.php?logout=<?php echo $user_id; ?>">LOG OUT</a></li>
...
<div class="small-container">
    <div class="row">
             <img src="../images/maresi.jpg" width="100%">
         <div class="col-2">
             <p>Maresi 0.25L </p>
...
<table id="table">
    ...
    <div class="facts">
        <p> <h3>Ingredients: </h3> Whole Cow Milk.</p>
        <p> <h3>Category: </h3> Milks</p>
        <p> <h3>Origin of ingredients: </h3> Austria</p>
        <p> <h3>Manufacturing or processing places:  </h3> Austria</p>
    </div>
