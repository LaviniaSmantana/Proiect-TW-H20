...
<html>
    <head>
        ...
        <title>SoDrO - Urban Monkey Smoothie</title>
        ...
        <a><img src="../images/logo.png"> </a>
            ...
            <i class="fa fa-times" onclick="hideMenu()"></i>
                <ul>
                    ...
                    <li><a href="urbanmonkey.php?logout=<?php echo $user_id; ?>">LOG OUT</a></li>
...
<div class="small-container">
    <div class="row">
             <img src="../images/urbanmonkey.jpg" width="100%">
         <div class="col-2">
            <p>Urban Monkey Raw Smoothie 250 ml </p>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
             <h1> Urban Monkey Mango Punch</h1>
             <h4>12.49 Lei</h4>
             <br>
             <br>
             <!-- <h5>Cantitate</h5>
...
<table id="table">
    ...
    <div class="facts">
        <p> <h3>Ingredients: </h3> Orange Juice, Apple Juice, Mango Puree, Passion Fruit Juice, Bananas, Ascorbic Acid.</p>
