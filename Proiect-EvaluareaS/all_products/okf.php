...
<html>
    <head>
        ...
        <title>SoDrO - OKF Smoothie</title>
        ...
        <a><img src="../images/logo.png"> </a>
            ...
            <i class="fa fa-times" onclick="hideMenu()"></i>
                <ul>
                    ...
                    <li><a href="okf.php?logout=<?php echo $user_id; ?>">LOG OUT</a></li>
...
<div class="small-container">
    <div class="row">
             <img src="../images/okf.jpg" width="100%">
         <div class="col-2">
             <p>OKF Smoothie 350 ml </p>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
             <h1> OKF Red Smoothie</h1>
             <h4>11.25 Lei</h4>
             <br>
             <br>
             <!-- <h5>Cantitate</h5>
...
<table id="table">
    ...
    <div class="facts">
        <p> <h3>Ingredients: </h3> Water, Fructose, Grapefruit Juice, Strawberry Juice, Cane Sugar, Skim Milk Powder, Mango Juice, Yogurt Powder.</p>
        <p> <h3>Category: </h3> Non-Carbonated drinks</p>
        <p> <h3>Origin of ingredients: </h3> Greece</p>
        <p> <h3>Manufacturing or processing places:  </h3> Spain</p>
    </div>
