...
<html>
    <head>
        ...
        <title>SoDrO - Vitamin Aqua </title>
        ...
        <a><img src="../images/logo.png"> </a>
            ...
            <i class="fa fa-times" onclick="hideMenu()"></i>
                <ul>
                    ...
                    <li><a href="vitaminaqua.php?logout=<?php echo $user_id; ?>">LOG OUT</a></li>
...
<div class="small-container">
    <div class="row">
             <img src="../images/vitaminB12.jpg" width="100%">
         <div class="col-2">
         <p>Vitamin Aqua 250 ml </p>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
             <h1> Vitamin Aqua B12</h1>
             <h4>6.54 Lei</h4>
             <br>
             <br>
             <!-- <h5>Cantitate</h5>
...
<table id="table">
    ...
    <div class="facts">
        <p> <h3>Ingredients: </h3> Water , Sugar, Citric Acid, Flavour, Carrot Concentrate, Sweetener.</p>
