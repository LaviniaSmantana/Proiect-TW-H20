        ...
        <nav>
            ...
            <i class="fa fa-times" onclick="hideMenu()"></i>
                <ul>
                    ...
                    <li><a href="tiger.php?logout=<?php echo $user_id; ?>">LOG OUT</a></li>
...
<div class="small-container">
    <div class="row">
             <img src="../images/tiger.png" width="100%">
         <div class="col-2">
             <p>Tiger Clasic Energy Drink 250 ml </p>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
             <h1>Tiger Clasic Energy Drink</h1>
             <h4>1.80 Lei</h4>
             <br>
             <br>
             <!-- <h5>Cantitate</h5>
...
<!-- <h2> ABOUT PRODUCT</h2> -->
    ...
    <div class="facts">
        <p> <h3>Ingredients: </h3>Water, sugar, citric acid, carbon dioxide, taurine, acidity regulator: sodium citrate, flavourings,<br>
                                  coloring: caramel (E150a), caffeine, inositol, glucuronolactone, preservative: sodium benzoate, sweetener:<br>
                                  sucralose, vitamins: niacin , pantothenic acid, vitamins B6 and B12.</p>
