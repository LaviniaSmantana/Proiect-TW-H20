        ...
        <nav>
            ...
            <i class="fa fa-times" onclick="hideMenu()"></i>
                <ul>
                    ...
                    <li><a href="redbullzero.php?logout=<?php echo $user_id; ?>">LOG OUT</a></li>
...
<div class="small-container">
    <div class="row">
             <img src="../images/RBZero.png" width="100%">
         <div class="col-2">
             <p>Red Bull Zero Energy Drink 250 ml </p>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
             <h1>Red Bull Zero Energy Drink</h1>
             <h4>5.30 Lei</h4>
             <br>
             <br>
             <!-- <h5>Cantitate</h5>
...
<!-- <h2> ABOUT PRODUCT</h2> -->
    ...
    <div class="facts">
        <p> <h3>Ingredients: </h3>water, acid (citric acid), carbon dioxide, taurine (0,4%), acidity regulators (sodium carbonates, magnesium carbonates),<br> sweeteners (acesulfame k, aspartame), caffeine (0,03%), vitamins (niacin nlathenic acid, b6, b12),<br> flavourings, thickener xanthan gum), colours (plain caramel, riboflavin) contiains a source of phenylanine</p>
        <p> <h3>Category: </h3> Energy drinks</p>
        <p> <h3>Origin of ingredients: </h3>Austria</p>
        <p> <h3>Countries where sold:  </h3> Australia, Austria, Belgium, France, Germany, Ireland, Italy, Spain, Switzerland, United Kingdom</p>
    </div>
