...
<html>
    <head>
        ...
        <title>SoDrO - Sour Cherry Syrup</title>
        ...
        <nav>
            ...
            <i class="fa fa-times" onclick="hideMenu()"></i>
                <ul>
                    ...
                    <li><a href="sirop-visine.php?logout=<?php echo $user_id; ?>">LOG OUT</a></li>
...
<div class="small-container">
    <div class="row">
             <img src="../images/sirop-visine.jpg" width="100%">
         <div class="col-2">
             <p>Sour Cherry Syrup 0.75L </p>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
             <h1> Sour Cherry Syrup Auchan</h1>
             <h4>9.20 Lei</h4>
             <br>
             <br>
             <!-- <h5>Cantitate</h5>
...
<!-- <h2> ABOUT PRODUCT</h2> -->
    ...
    <div class="facts">
        <p> <h3>Ingredients: </h3> Sugar, water, sour cherry juice (18.4%), citric acid, natural sour cherry flavor, preservative. </p>
