...
<html>
    <head>
        ...
        <title>SoDrO - Blackcurrant Syrup</title>
        ...
        <nav>
            ...
            <i class="fa fa-times" onclick="hideMenu()"></i>
                <ul>
                    ...
                    <li><a href="sirop-coacaze.php?logout=<?php echo $user_id; ?>">LOG OUT</a></li>
...
<div class="small-container">
    <div class="row">
             <img src="../images/sirop-coacaze.jpg" width="100%">
         <div class="col-2">
             <p>Blackcurrant Syrup 0.7L </p>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
             <h1> Blackcurrant Syrup Yo</h1>
             <h4>19.40 Lei</h4>
             <br>
             <br>
             <!-- <h5>Cantitate</h5>
...
<!-- <h2> ABOUT PRODUCT</h2> -->
    ...
    <div class="facts">
        <p> <h3>Ingredients: </h3> Sugar, glucose-fructose syrup, fruit juice obtained from blackcurrant concentrate (10%), water, citric acid. </p>
