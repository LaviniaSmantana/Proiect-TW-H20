        ...
        <nav>
            ...
            <i class="fa fa-times" onclick="hideMenu()"></i>
                <ul>
                    ...
                    <li><a href="hellmere.php?logout=<?php echo $user_id; ?>">LOG OUT</a></li>
...
<div class="small-container">
    <div class="row">
             <img src="../images/hellmere.png" width="100%">
         <div class="col-2">
             <p>Hell Apples Energy Drinks 250 ml </p>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
             <h1>Hell Apple Energy drink</h1>
             <h4>2.60 Lei</h4>
             <br>
             <br>
             <!-- <h5>Cantitate</h5>
...
<!-- <h2> ABOUT PRODUCT</h2> -->
    ...
    <div class="facts">
        <p> <h3>Ingredients: </h3>drinking water, sugar, edible acid (citric acid), carbon dioxide (min. 3 g / l), acidity regulator (sodium citrates), <br>
                                 flavorings; caffeine (38.4 mg / 100 ml); dye (ammonia caramel); vitamins [niacin (B3), pantothenic acid (B5), <br>
                                 pyridoxine (B6), riboflavin (B2), cobalamin (B12)], glucuronolactone, inositol</p>
        <p> <h3>Category: </h3> Energy drinks</p>
        <p> <h3>Labels, certifications, awards: </h3> Entrepreneurs + Committed</p>
        <p> <h3>Countries where sold:  </h3> Hungary</p>
    </div>
