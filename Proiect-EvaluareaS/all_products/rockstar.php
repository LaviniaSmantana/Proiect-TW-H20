        ...
        <nav>
            ...
            <i class="fa fa-times" onclick="hideMenu()"></i>
                <ul>
                    ...
                    <li><a href="rockstar.php?logout=<?php echo $user_id; ?>">LOG OUT</a></li>
...
<div class="small-container">
    <div class="row">
             <img src="../images/rockstar.png" width="100%">
         <div class="col-2">
             <p>Rockstar original Energy Drink 250 ml </p>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
             <h1>Rockstar original Energy Drink</h1>
             <h4>2.95 Lei</h4>
             <br>
             <br>
             <!-- <h5>Cantitate</h5>
...
<!-- <h2> ABOUT PRODUCT</h2> -->
    ...
    <div class="facts">
        <p> <h3>Ingredients: </h3>Water, ctronic acid, sodium citrates, taurine (0.2%), aroma, caffeine(0.0324),glucuronolactone (0.024%), <br>
                                  colors(ammon sulfate sugar color,riboflavins), ginseng aroma extract (0.01%) inosite (0,01%), guarana extract (0.01%),<br>
                                  nicotine acid, pantothenate, vitamin B6, vitamin B12</p>
