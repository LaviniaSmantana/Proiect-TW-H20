        ...
        <nav>
            ...
            <i class="fa fa-times" onclick="hideMenu()"></i>
                <ul>
                    ...
                    <li><a href="fanta-madness.php?logout=<?php echo $user_id; ?>">LOG OUT</a></li>
...
<div class="small-container">
    <div class="row">
             <img src="../images/fantam.png" width="100%">
         <div class="col-2">
             <p> Fanta Madness 2 L </p>
...
<!-- <h2> ABOUT PRODUCT</h2> -->
    ...
    <div class="facts">
        <p> <h3>Ingredients: </h3> water, fructose-glucose syrup, carbon dioxide, flavorings,<br> extracts of fruit and vegetables (carrot, apple), acid: citric acid and malic acid,<br> grape juice from concentrate [0,1%), acidity regulator: sodium gluconate,<br> preservative: potassium sorbate, sweeteners: sucralose and sacharine</p>
