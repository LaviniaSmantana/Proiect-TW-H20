        ...
        <a><img src="../images/logo.png"> </a>
            ...
            <i class="fa fa-times" onclick="hideMenu()"></i>
                <ul>
                    ...
                    <li><a href="tedi.php?logout=<?php echo $user_id; ?>">LOG OUT</a></li>
...
<div class="small-container">
    <div class="row">
             <img src="../images/tedi.jpg" width="100%">
         <div class="col-2">
             <p>Tedi 200 ml </p>
                 ...
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
             <h1> Tedi Carrot-Apple-Orange </h1>
             <h4>1.55 Lei</h4>
             <br>
             <br>
             <!-- <h5>Cantitate</h5>
...
<table id="table">
    ...
    <div class="facts">
        <p> <h3>Ingredients: </h3> Water, Carrot Puree, Apple Puree, Orange Puree, Honey.</p>
