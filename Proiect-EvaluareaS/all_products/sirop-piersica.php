...
<html>
    <head>
        ...
        <title>SoDrO - Peach-Maracuja Syrup</title>
        ...
        <nav>
            ...
            <i class="fa fa-times" onclick="hideMenu()"></i>
                <ul>
                    ...
                    <li><a href="sirop-piersica.php?logout=<?php echo $user_id; ?>">LOG OUT</a></li>
...
<div class="small-container">
    <div class="row">
             <img src="../images/sirop-piersica.png" width="100%">
         <div class="col-2">
             <p>Peach-Maracuja Syrup 0.7L </p>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
             <h1> Peach-Maracuja Syrup Mautner</h1>
             <h4>14.00 Lei</h4>
             <br>
             <br>
             <!-- <h5>Cantitate</h5>
...
<!-- <h2> ABOUT PRODUCT</h2> -->
    ...
    <div class="facts">
        <p> <h3>Ingredients: </h3> Water, peach juice from concentrate (17%), maracuja, citric acid, sweeteners. </p>
