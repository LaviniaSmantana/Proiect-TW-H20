...
<html>
    <head>
        ...
        <title>SoDrO - Sloop Smoothie</title>
        ...
        <a><img src="../images/logo.png"> </a>
            ...
            <i class="fa fa-times" onclick="hideMenu()"></i>
                <ul>
                    ...
                    <li><a href="sloop.php?logout=<?php echo $user_id; ?>">LOG OUT</a></li>
...
<div class="small-container">
    <div class="row">
             <img src="../images/sloop.jpg" width="100%">
         <div class="col-2">
             <p>Sloop Smoothie 250 ml </p>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
             <h1> Smuti cu Mango și Fructul Pasiunii</h1>
             <h4>9.99 Lei</h4>
             <br>
             <br>
             <!-- <h5>Cantitate</h5>
...
<table id="table">
    ...
    <div class="facts">
        <p> <h3>Ingredients: </h3> Apple Juice , Banana Puree, Mango Puree, Passion Fruit Juice, Vitamin C.</p>
