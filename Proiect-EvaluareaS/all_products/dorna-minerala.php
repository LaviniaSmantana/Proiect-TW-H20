...
<html>
    <head>
        ...
        <title>SoDrO - Dorna Mineral Water</title>
        ...
        <nav>
            ...
            <i class="fa fa-times" onclick="hideMenu()"></i>
                <ul>
                    ...
                    <li><a href="dorna-minerala.php?logout=<?php echo $user_id; ?>">LOG OUT</a></li>
...
<div class="small-container">
    <div class="row">
             <img src="../images/dorna-minerala.jpg" width="100%">
         <div class="col-2">
             <p>Dorna 2L </p>
...
<!-- <h2> ABOUT PRODUCT</h2> -->
    ...
    <div class="facts">
        <p> <h3>Ingredients: </h3> Natural mineral water, Calcium, Magnesium.</p>
