        ...
        <nav>
            ...
            <i class="fa fa-times" onclick="hideMenu()"></i>
                <ul>
                    ...
                    <li><a href="pepsi.php?logout=<?php echo $user_id; ?>">LOG OUT</a></li>
...
<div class="small-container">
    <div class="row">
             <img src="../images/pepsi.png" width="100%">
         <div class="col-2">
             <p>Pepsi 2 L </p>
...
<!-- <h2> ABOUT PRODUCT</h2> -->
    ...
    <div class="facts">
        <p> <h3>Ingredients: </h3> carbonated water, sugar, colour</p>
        <p> <h3>Category: </h3> Carbonated drinks</p>
        <p> <h3>Labels, certifications, awards: </h3> Green Dot</p>
        <p> <h3>Countries where sold:  </h3> Belgium, France, Germany</p>
    </div>
