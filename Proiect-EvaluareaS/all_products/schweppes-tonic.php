        ...
        <nav>
            ...
            <i class="fa fa-times" onclick="hideMenu()"></i>
                <ul>
                    ...
                    <li><a href="schweppes-tonic.php?logout=<?php echo $user_id; ?>">LOG OUT</a></li>
...
<div class="small-container">
    <div class="row">
             <img src="../images/schweppesa.png" width="100%">
         <div class="col-2">
             <p> Schweppes Tonic Water 1,5 L </p>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
             <h1> Schweppes Tonic Water </h1>
             <h4>5.69 Lei</h4>
             <br>
             <br>
             <!-- <h5>Cantitate</h5>
...
<!-- <h2> ABOUT PRODUCT</h2> -->
    ...
    <div class="facts">
        <p> <h3>Ingredients: </h3> Carbonated water, acidifier: citric acid, sweeteners: <br> acesulfame K and sucralose, natural flavors, aroma: quinine</p>
        <p> <h3>Category: </h3> Carbonated drinks</p>
        <p> <h3>Labels, certifications, awards:</h3>Low or no sugar, No added sugar, No aspartame, No sugar</p>
        <p> <h3>Countries where sold: </h3> France, Switzerland</p>
    </div>
