        ...
        <nav>
            ...
            <i class="fa fa-times" onclick="hideMenu()"></i>
                <ul>
                    ...
                    <li><a href="fanta-grapefruit.php?logout=<?php echo $user_id; ?>">LOG OUT</a></li>
...
<div class="small-container">
    <div class="row">
             <img src="../images/fanta-grepfruit.png" width="100%">
         <div class="col-2">
             <p> Fanta Grapefruit 2 L </p>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
             <h1> Fanta Grapefruit </h1>
             <h4>5.65 Lei</h4>
             <br>
             <br>
             <!-- <h5>Cantitate</h5>
...
<!-- <h2> ABOUT PRODUCT</h2> -->
    ...
    <div class="facts">
        <p> <h3>Ingredients: </h3> Water, pink grapefruit juice from grapefruit juice concentrate, carbonic acid, <br> citric acid, food coloring (chokeberry concentrate and shock),<br> sweeteners (acesulfame K, aspartame), flavors, stabilizers E414 and E445</p>
        <p> <h3>Category: </h3> Carbonated drinks</p>
        <p> <h3>Labels, certifications, awards:</h3>Low or no sugar, No sugar</p>
        <p> <h3>Countries where sold: </h3>Germany</p>
    </div>
