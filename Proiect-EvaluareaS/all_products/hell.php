        ...
        <nav>
            ...
            <i class="fa fa-times" onclick="hideMenu()"></i>
                <ul>
                    ...
                    <li><a href="hell.php?logout=<?php echo $user_id; ?>">LOG OUT</a></li>
...
<div class="small-container">
    <div class="row">
             <img src="../images/hell.png" width="100%">
         <div class="col-2">
             <p>Hell Energy Energy Drink 250 ml </p>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
             <h1>Hell Energy Energy Drink</h1>
             <h4>2.60 Lei</h4>
             <br>
             <br>
             <!-- <h5>Cantitate</h5>
...
<!-- <h2> ABOUT PRODUCT</h2> -->
    ...
    <div class="facts">
        <p> <h3>Ingredients: </h3>Ingredients drinking water, sugar, edible acid (citric acid), carbon dioxide (min. 0.3%); <br>acidity regulator (sodium citrate); caffeine (0.03%); flavor; Vitamins caramel ammonia (vitamin B3 (niacin), <br>vitamin B6 (pantothenic acid), Total nutritional value / 100 ml 194KJ / 46 kca ... CAFE.caffeine 32 mg / 100 ml) <br>of which culkrok 10.9 Vitamin B6 (pyridoxine), Vitamin B2 (riboflavin), vitamin B12</p>
        <p> <h3>Category: </h3> Energy drinks</p>
        <p> <h3>Origin of ingredients: </h3> Hungary</p>
        <p> <h3>Countries where sold:  </h3> Bulgaria, Cyprus, Greece, Hungary, North Macedonia, Romania, Russia, Serbia, United Kingdom</p>
    </div>
