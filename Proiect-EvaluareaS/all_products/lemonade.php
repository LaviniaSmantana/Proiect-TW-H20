...
<html>
    <head>
        ...
        <title>SoDrO - Cappy Lemonade</title>
        ...
        <a><img src="../images/logo.png"> </a>
            ...
            <i class="fa fa-times" onclick="hideMenu()"></i>
                <ul>
                    ...
                    <li><a href="lemonade.php?logout=<?php echo $user_id; ?>">LOG OUT</a></li>
...
<div class="small-container">
    <div class="row">
             <img src="../images/limonada.jpg" width="100%">
         <div class="col-2">
             <p>Cappy Lemonade 400 ml </p>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
                 <i class="fa fa-star-o"></i>
             <h1> Cappy Lemonade Lemon & Kiwi </h1>
             <h4>7.30 Lei</h4>
             <br>
             <br>
             <!-- <h5>Cantitate</h5>
...
<table id="table">
    ...
    <div class="facts">
        <p> <h3>Ingredients: </h3> Water, Lemon Juice Concentrate, Sugar, Acidity Corrector, Kiwi Flavor, Ascorbic Acid.</p>
        <p> <h3>Category: </h3> Non-Carbonated drinks</p>
        <p> <h3>Origin of ingredients: </h3> Poland</p>
        <p> <h3>Manufacturing or processing places:  </h3> Poland</p>
    </div>
