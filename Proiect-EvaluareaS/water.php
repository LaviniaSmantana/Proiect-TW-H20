...
if(empty($_SESSION["shopping_cart"])) {
 ...
 Product is already added to your cart!</div>"; 
    ...
    $status = "<div class='box'>Product is added to your cart!</div>";
    $select = "UPDATE  `products` SET bought = bought + 1 WHERE code = '$code'";
    ...
    <nav>
        ...
        <div class="nav-links" id="navLinks">
            ...
            <ul>
                ...
                <li><a href="water.php?logout=<?php echo $user_id; ?>">LOG OUT</a></li>
                <li><a href="list.php"><img src="images/cart-icon.png" />
                    <?php
                    if(!empty($_SESSION["shopping_cart"])) {
                    $cart_count = count(array_keys($_SESSION["shopping_cart"]));
                    ?>
                    Cart</a><span class="imgcart">
...
<div class="category">
 <div class="links">
    ...
    <h1>Water</h1> 
    <h3><a href="syrups.php">Syrups</h3></a>
    <h3><a href="milks.php">Milk</h3></a>
    <h3><a href="energydrinks.php">Energy Drinks</h3></a>
 </div>
 <?php
$result = mysqli_query($conn,"SELECT * FROM `products` where id>20 AND id<=30");
