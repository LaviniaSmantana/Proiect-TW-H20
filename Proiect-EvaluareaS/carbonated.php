    ...
    <nav>
        ...
        <div class="nav-links" id="navLinks">
            ...
            <ul>
                ...
                <li><a href="carbonated.php?logout=<?php echo $user_id; ?>">LOG OUT</a></li>
...
<div class="category">
 ...
 <?php
$result = mysqli_query($conn,"SELECT * FROM `products` where id>0 AND id<=10");
